...
INSERT INTO global_property (property, property_value, `description`, uuid) VALUES ('create.from.dde.server', 'true', 'Demographics Data Exchange connection parameter', (SELECT UUID()));
